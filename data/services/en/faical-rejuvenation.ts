...
const facialRejuvenation: PageData = {
  title: 'Advanced Facial Rejuvenation at Roop Clinic',
  subtitle: 'Expert Non-Surgical & Surgical Solutions for Youthful Appearance',
  ...
  procedureInfo: {
    coloredTitle: 'Comprehensive Facial',
  ...
  secondSection: {
    coloredHeading: 'Surgical',
    heading: 'Facial Rejuvenation Options',
    description:
      '<strong>Blepharoplasty (Eyelid Surgery)</strong> corrects drooping upper eyelids and puffy lower eyelids by removing excess skin, muscle, and fat. <strong>Upper Blepharoplasty</strong> removes excess upper eyelid skin that impairs vision or creates tired appearance, improving field of vision and creating more alert, youthful eyes. <strong>Lower Blepharoplasty</strong> removes or repositions fat pockets creating under-eye bags, removes excess lower eyelid skin, and reduces dark circles and hollows. Procedure takes 1-2 hours under local anesthesia with sedation or general anesthesia. Recovery involves 1-2 weeks of swelling and bruising, with final results visible in 3-6 months. Scars are hidden in natural eyelid creases and fade to nearly invisible. Results are long-lasting, typically 10-15 years.',
    features: [
      '<strong>Facelift (Rhytidectomy)</strong> is the gold standard surgical procedure for comprehensive facial rejuvenation, addressing sagging skin, deep wrinkles, jowls, and loss of facial definition. The procedure lifts and tightens facial tissues, repositions underlying muscles (SMAS layer), removes excess skin, and restores youthful facial contours. <strong>Traditional Facelift</strong> addresses lower two-thirds of face including cheeks, jowls, and jawline. <strong>Mini Facelift</strong> targets early signs of aging with smaller incisions and shorter recovery. <strong>Deep Plane Facelift</strong> provides most comprehensive lift by repositioning deeper facial structures. Surgery takes 3-5 hours under general anesthesia. Recovery requires 2-3 weeks before returning to work, 4-6 weeks before strenuous activity. Results last 10-15 years with proper skincare.',
      '<strong>Neck Lift (Lower Rhytidectomy)</strong> addresses aging neck concerns including loose, sagging neck skin (turkey neck), visible neck bands (platysma muscles), excess fat under chin (submental fullness), and poorly defined jawline. The procedure tightens neck muscles, removes excess skin and fat, creates smooth neck contour and defined jawline. Often combined with facelift for comprehensive lower face and neck rejuvenation. Procedure takes 2-3 hours under general anesthesia. Recovery involves 1-2 weeks of swelling and bruising. Incisions are hidden behind ears and in hairline. Results are dramatic and long-lasting (10-15 years).',
    ],
  },
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        'Our goal is natural-looking enhancement that makes you look refreshed and youthful, not "overdone" or obviously treated. We use conservative approach with gradual improvements, focusing on maintaining your natural facial expressions and features. You should look like a better, more refreshed version of yourself.',
    },
    {
