...
const laserHairReduction: PageData = {
  title: 'Advanced Laser Hair Reduction at Roop Clinique',
  subtitle: 'Safe, Effective & Long-Lasting Hair Removal by Expert Hands',
  ...
  secondSection: {
    ...
    features: [
      ...
      '<strong>Important Considerations:</strong> For darker skin tones, special precautions and specific laser types may be recommended. Don\'t use sunless tanning creams before treatment - your skin should be as light as possible. Inform the technician about any medications, skin conditions, or recent sun exposure. Laser hair reduction is a medical procedure requiring trained professionals - always choose a qualified clinic like Roop Clinique.',
    ],
  },
  ...
  procedure: {
    steps: [
      ...
      },
      {
        ...
        description: [
          '<strong>Immediately After Treatment:</strong> The treated area may look and feel like a mild sunburn for 1-2 days. Apply cool compresses and gentle moisturizers as needed. If your face was treated, you can wear makeup the next day unless there is blistering. Avoid direct sunlight, tanning beds, sun lamps, and any indoor tanning equipment for at least 4 weeks.',
          '<strong>Post-Treatment Care:</strong> Treated hair will fall out over the next 2-4 weeks. Use broad-spectrum sunscreen (SPF 30+) on treated areas to prevent temporary pigmentation changes. Avoid hot showers, saunas, and strenuous exercise for 24-48 hours. Do not pick or scratch the treated area. Attend all scheduled follow-up sessions for optimal results.',
        ],
      },
      {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        'Most patients describe the sensation as a warm pinprick or rubber band snap - significantly less painful than waxing or threading. Modern lasers at Roop Clinique have built-in cooling mechanisms that minimize discomfort. Topical numbing cream can be applied for sensitive areas. Pain tolerance varies by individual and treatment area.',
    },
    {
      question: 'How many sessions will I need?',
      answer:
        'Most patients require 6-8 sessions spaced 4-6 weeks apart for optimal results. The exact number depends on the treatment area, hair thickness, hair color, and your individual hair growth cycle. Some patients may need maintenance sessions every 6-12 months after completing the initial treatment course.',
    },
    {
      question: 'Can laser hair reduction work on all skin types?',
      answer:
        'Yes! Modern laser technology at Roop Clinique can safely treat all skin types, including Indian skin tones. Different laser wavelengths and settings are used for different skin types. Darker skin requires special protocols to ensure safety. During consultation, our experts will assess your skin type and customize the treatment plan accordingly.',
    },
    {
      question: 'What areas of the body can be treated?',
      answer:
        'Laser hair reduction can treat most body areas including face (upper lip, chin, cheeks, sideburns), underarms, arms, legs, bikini line, back, chest, abdomen, and shoulders. It cannot be performed on eyelids, areas around the eyes, or tattooed skin.',
    },
    {
      question: 'What should I avoid before and after treatment?',
      answer:
        'Before: Avoid waxing, plucking, and electrolysis for 6 weeks; avoid sun exposure for 6 weeks; shave the day before treatment; avoid blood thinners. After: Avoid sun exposure and use sunscreen for 4+ weeks; avoid hot showers and exercise for 24-48 hours; don\'t pick or scratch treated areas; attend all follow-up sessions.',
    },
    {
      question: 'Are there any side effects?',
      answer:
        'Common temporary side effects include redness, swelling, and mild discomfort that resolve within hours to days. Rare complications include blistering, temporary pigmentation changes, and scarring. At Roop Clinique, our trained professionals use appropriate settings for your skin type, minimizing all risks.',
    },
  ],
